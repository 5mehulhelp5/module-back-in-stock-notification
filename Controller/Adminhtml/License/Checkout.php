...
class Checkout extends Action
{
    ...
    public function execute(): ResultInterface
    {
        ...
        $gate = $this->resultFactory->create(ResultFactory::TYPE_REDIRECT)->setPath('etechflow_bisn/license/gate');
        ...
        $payload = json_encode([
            ...
            'magento_callback' => $this->getUrl('etechflow_bisn/license/activated'),
            'magento_cancel'   => $this->getUrl('etechflow_bisn/license/gate'),
        ]);
